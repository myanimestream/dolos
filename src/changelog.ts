...
const CHANGELOG: Changelog = new Map([
    ["0.2.0", [
        ...
        `Rewrote some of the storage logic. This resets all Animes overwritten using "Search Anime" which means you will have to do it again. Tremendously sorry about that!`,
