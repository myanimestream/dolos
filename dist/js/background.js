...
var _this = this;
Object.defineProperty(exports, "__esModule", { value: true });
var state = __webpack_require__(/*! ./observables */ "./src/background/observables.ts");
...
state.hasNewVersion$.subscribe(function (val) { return chrome.browserAction.setBadgeText({ text: val ? _("ext_badge__new_version") : "" }); });
...
if (!chrome.browserAction)
    throw new Error("Background imported in non-background page context!");
__webpack_require__(/*! ./events */ "./src/background/events.ts");
__webpack_require__(/*! ./telemetry */ "./src/background/telemetry.ts");


/***/ }),

/***/ "./src/background/observables.ts":
/*!***************************************!*\
  !*** ./src/background/observables.ts ***!
  \***************************************/
/*! no static exports found */
...
if (!chrome.browserAction)
    throw new Error("Background imported in non-background page context!");
var rxjs = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
exports.hasNewVersion$ = new rxjs.BehaviorSubject(false);
window["hasNewVersion$"] = exports.hasNewVersion$;
